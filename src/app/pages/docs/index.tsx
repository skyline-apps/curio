    ...
    <div className="flex flex-col w-full h-dvh overflow-hidden">
      ...
      <div className="flex flex-row flex-1 relative overflow-y-auto">
        <AppPage enforceAuth={false}>
          <div className="w-full lg:w-4xl max-w-4xl self-start pl-2 pt-4 mx-auto select-text">
            <h1 className="text-2xl font-medium mb-4">Curio user guide</h1>
            <Markdown
              className="select-text [&_h1]:text-xl [&_h1]:font-bold [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:text-lg [&_h3]:font-medium [&_h4]:text-base [&_h4]:font-medium [&_h5]:text-sm [&_h5]:font-medium [&_h6]:text-sm [&_h6]:font-medium [&_p]:text-sm [&_li]:text-sm [&_blockquote]:text-sm [&_code]:text-xs"
